            ...
            <div class="card-body">
                ...
                <form id="form-pendaftaran">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nama_kelompok" class="form-control" placeholder="Masukkan sesuai nama kelompok yang tertuang dalam Anggaran Dasar">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="bidang_kegiatan" class="form-control" placeholder="Masukkan sesuai dengan bidang yang dijalankan">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="program_kerja" class="form-control" placeholder="Masukkan sesuai dengan bidang yang dijalankan">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="alamat_kantor" class="form-control" rows="2" placeholder="Masukkan sesuai surat Keterangan Domisili dari Desa"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="asas" class="form-control" placeholder="Masukkan sesuai yang tidak bertentangan dengan Pancasila">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tujuan_kelompok" class="form-control" placeholder="Masukkan tujuan kelompok">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="nik_pendiri" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="tl_pendiri" class="form-control" placeholder="Tempat">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">Nomor HP <span class="text-danger">(WAJIB)</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="hp_pendiri" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nama_pembina" class="form-control" placeholder="Jika ada dibuktikan dengan surat pernyataan kesediaan">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nama_penasehat" class="form-control" placeholder="Jika ada dibuktikan dengan surat pernyataan kesediaan">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">NIK</label>
                                <div class="col-sm-9">
                                    <input type="text" name="nik_ketua_pengurus" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">Tempat, Tgl Lahir</label>
                                <div class="col-sm-5">
                                    <input type="text" name="tl_ketua_pengurus" class="form-control" placeholder="Tempat">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">Nomor HP <span class="text-danger">(WAJIB)</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="hp_ketua_pengurus" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">NIK</label>
                                <div class="col-sm-9">
                                    <input type="text" name="nik_sekretaris_pengurus" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">Tempat, Tgl Lahir</label>
                                <div class="col-sm-5">
                                    <input type="text" name="tl_sekretaris_pengurus" class="form-control" placeholder="Tempat">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">Nomor HP <span class="text-danger">(WAJIB)</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="hp_sekretaris_pengurus" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">NIK</label>
                                <div class="col-sm-9">
                                    <input type="text" name="nik_bendahara_pengurus" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">Tempat, Tgl Lahir</label>
                                <div class="col-sm-5">
                                    <input type="text" name="tl_bendahara_pengurus" class="form-control" placeholder="Tempat">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-3 col-form-label">Nomor HP <span class="text-danger">(WAJIB)</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="hp_bendahara_pengurus" class="form-control" maxlength="16" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="masa_kepengurusan" class="form-control" placeholder="Masukkan sesuai dengan surat keputusan Kelompok">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="keputusan_kelompok" class="form-control" placeholder="Masukkan sesuai dengan Aggaran Dasar">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sumber_keuangan" class="form-control" placeholder="Masukkan sesuai Dalam Negeri/Luar Negeri ">
                        </div>
                    </div>
        ...
        $('#form-pendaftaran').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#form-pendaftaran').find('input, textarea, select').not('#nomor-registrasi').val('');
