                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('persyaratan.update', $persyaratan->id) }}" method="POST" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="nama_persyaratan" name="nama_persyaratan" value="{{ old('nama_persyaratan', $persyaratan->nama_persyaratan) }}" required>
                        </div>

                        <div class="col-12">
                            <label for="keterangan" class="form-label">Keterangan</label>
                            <textarea class="form-control" id="keterangan" name="keterangan" rows="4" required>{{ old('keterangan', $persyaratan->keterangan) }}</textarea>
                        </div>
