...
<head>
  ...
  <title>Pelayanan - KESBANGPOL</title>
  ...
  <style>
  .accent-background {
    background-image: url('{{ asset("landing/assets/img/cta-bg.jpg") }}');
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <img src="{{asset('/')}}landing/assets/img/juara2.png" alt="">
      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-6 justify-content-between">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h2><span>Selamat Datang</span><span class="accent"> Dipelayanan KESBANGPOL</span></h2>
          ...
          <div class="col-lg-6 order-1 order-lg-2">
           <img src="{{ asset('/') }}landing/assets/img/bupati.png" class="img-fluid" alt="" style="width: 100%; max-width: 800px;">
          ...
          <div class="row gy-4 mt-5">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="https://lestari.luwutimurkab.go.id/login-page" class="stretched-link">LESTARI</a></h4>
              </div>
            </div><!--End Icon Box -->
            ...
            <div class="col-xl-4 col-md-6">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="https://simamat.luwutimurkab.go.id/" class="stretched-link">SIMAMAT</a></h4>
              </div>
            </div><!--End Icon Box -->
            ...
            <div class="col-xl-4 col-md-6">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="" class="stretched-link">Kelompok Tani</a></h4>
              </div>
            </div><!--End Icon Box -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="{{asset('/')}}landing/assets/img/blog/blog-author.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <article>
              ...
              <div class="post-img">
                <img src="{{asset('/')}}landing/assets/img/blog/blog-2.jpg" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="{{asset('/')}}landing/assets/img/blog/blog-author-2.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <article>
              ...
              <div class="post-img">
                <img src="{{asset('/')}}landing/assets/img/blog/blog-3.jpg" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="{{asset('/')}}landing/assets/img/blog/blog-author-3.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
